        ...
        NavigationStack {
            List {
                ...
                Section("当前设备") {
                    ...
                    TextFieldLink(prompt: Text("输入激活码")) {
                        Label(
                            draftActivationCode.nonEmptyTrimmed ?? "输入激活码",
                            systemImage: "keyboard"
                        )
                    } onSubmit: { submittedCode in
                        draftActivationCode = submittedCode
                        Task {
                            await applyActivationCode(submittedCode)
                        }
                    }
